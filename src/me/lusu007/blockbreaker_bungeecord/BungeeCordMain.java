...
import me.lusu007.blockbreaker_bungeecord.playermanagement.ban.Commands.Commands_Ban;
import me.lusu007.blockbreaker_bungeecord.playermanagement.ban.Commands.Commands_Check;
import me.lusu007.blockbreaker_bungeecord.playermanagement.ban.Commands.Commands_TempBan;
import me.lusu007.blockbreaker_bungeecord.playermanagement.ban.Commands.Commands_Unban;
import me.lusu007.blockbreaker_bungeecord.playermanagement.ban.commands.Commands_Ban;
import me.lusu007.blockbreaker_bungeecord.playermanagement.ban.commands.Commands_Check;
import me.lusu007.blockbreaker_bungeecord.playermanagement.ban.commands.Commands_TempBan;
import me.lusu007.blockbreaker_bungeecord.playermanagement.ban.commands.Commands_Unban;
import me.lusu007.blockbreaker_bungeecord.playermanagement.ban.events.Login;
...
public class BungeeCordMain extends Plugin {
    ...
    private void registerAll() {
        ...
        ProxyServer.getInstance().getPluginManager().registerCommand(this, new Commands_Ban("ban"));
        ProxyServer.getInstance().getPluginManager().registerCommand(this, new Commands_TempBan("tempban"));
        ProxyServer.getInstance().getPluginManager().registerCommand(this, new Commands_Check("check"));
        ProxyServer.getInstance().getPluginManager().registerCommand(this, new Commands_Unban("unban"));
